...
x_act=0;    %Startgeschwindigkeit über timervalue anpassen, x_act wird anhand von timervalue berechnet
v_act=0;
x_ziel=1000;
v_ziel=30;
a_max=5;
...
while(x_act ~= x_ziel) %solange Zielpunkt nicht erreicht wurde
   ...
   if(v_act >= v_ziel)  %Wenn die aktuelle Geschwindigkeit größer als die Zielgeschwindigkeit ist
